...
def graph_date(df):
    ...
    # 軸の縦線の色を変更している
    ax1.tick_params(axis='y', colors=color_1, direction='in')
    ax2.tick_params(axis='y', colors=color_2, direction='in')
...
def graph_dy(df):
    ...
    ax1.tick_params(axis='y', colors=color_1, direction='in')
    ax2.tick_params(axis='y', colors=color_2, direction='in')
    ax1.tick_params(axis='x', which='major',direction='in',length = 20,width = 2)
    ax2.tick_params(axis='x', which='major',direction='in',length = 20,width = 2)
